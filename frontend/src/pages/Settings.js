...
import { Upload, Save, Palette, Plus, Trash2, GripVertical, ArrowUp, ArrowDown } from 'lucide-react';
  ...
  return (
    <div className="animate-fade-in max-w-4xl">
      ...
      <div className="space-y-6">
        ...
        {/* RSS */}
        <Card>
          <CardHeader><CardTitle className="text-base">Flux RSS</CardTitle></CardHeader>
          <CardContent>
            <div className="space-y-2">
              <Label className="text-xs">URL du flux RSS (s'ajoute au bandeau defilant)</Label>
              <Input value={s.footer_rss_url || ''} onChange={e => up('footer_rss_url', e.target.value)}
                placeholder="https://example.com/rss.xml" data-testid="footer-rss-input" />
              <p className="text-[11px] text-slate-400">Les titres du flux RSS seront ajoutes au bandeau defilant automatiquement.</p>
            </div>
          </CardContent>
        </Card>
